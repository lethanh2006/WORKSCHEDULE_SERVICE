...
export const getMyWorkRequests = async (req, res) => {
    try {
        const filter = { employee_id: getEmployeeId(req) };
...
export const getMyWorkRequestStats = async (req, res) => {
    try {
        const filter = { employee_id: getEmployeeId(req) };
        const monthRange = parseMonth(req.query.month);
        if (req.query.month && !monthRange) {
...
export const cancelMyWorkRequest = async (req, res) => {
    try {
...
export const approveWorkRequest = async (req, res) => {
    try {
